...
function build_amplitude(ch::TreeChannel, rules::FeynmanRules, model::AbstractModel)
    ...
    _build_amplitude(ch, rules, model, exch)
end

# Dispatch on exchanged field species (not isa cascades — Rule 8)
function _build_amplitude(ch::TreeChannel, rules::FeynmanRules,
                          model::AbstractModel, ::Field{Boson})
...
function _build_amplitude(ch::TreeChannel, rules::FeynmanRules,
                          model::AbstractModel, ::Field{Fermion})
